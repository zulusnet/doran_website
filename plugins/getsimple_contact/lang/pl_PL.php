...
$i18n = array (
	...
	"SC_DESC" => "Simple contact form plugin for GetSimple",
        ...
        "SC_FE_SUBJECT" => "Temat:",
        "SC_FE_EMAIL" => "Twój email:",
        "SC_FE_MESSAGE" => "Wiadomość:",
        "SC_FE_CAPTCHA" => "Captcha:",
        "SC_FE_CAPTCHA_RELOAD" => "Odśwież",
        "SC_FE_CAPTCHA_GET_AUDIO" => "GET AUDIO",
        "SC_FE_CAPTCHA_GET_IMAGE" => "GET IMAGE",
        "SC_FE_NAME_PLACEHOLDER" => "Podaj imię i nazwisko",
        "SC_FE_SUBJECT_PLACEHOLDER" => "Podaj temat wiadomości",
        "SC_FE_EMAIL_PLACEHOLDER" => "Podaj adres email",
        "SC_FE_RECAPTCHA_PLACEHOLDER" => "Podaj kod reCaptcha",
        "SC_FE_OPENCAPTCHA_PLACEHOLDER" => "Podaj kod captcha",
        "SC_FE_MESSAGE_PLACEHOLDER" => "Podaj treść wiadomości",
        "SC_FE_SUBMIT" => "Wyślij",
        "SC_FE_BE_SUBMIT" => "Zapisz",
        "SC_FE_NAME_REQUIRED" => "Twoje imię i nazwisko jest wymagane.",
        "SC_FE_SUBJECT_REQUIRED" => "Temat wiadomości jest wymagany.",
        "SC_FE_EMAIL_REQUIRED" => "Twój adres email jest wymagany.",
        "SC_FE_EMAIL_INVALID" => "Twój adres email jest nieprawidłowy.",
        "SC_FE_MESSAGE_REQUIRED" => "Tekst wiadomości jest wymagany.",
        "SC_FE_CAPTCHA_REQUIRED" => "Kod captcha jest wymagany.",
        "SC_FE_INCORRECT-CAPTCHA-SOL" => "Podany kod captcha jest nieprawidłowy.",
        "SC_FE_CAPTCHA-TIMEOUT" => "Aktualny kod captcha uległ przedawnieniu.",
        ...
        "SC_FE_MESSAGE_SENT" => "Twoja wiadomość została wysłana.",
