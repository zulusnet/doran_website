...
?>
<p class="search-no-results alert alert-danger"><?php echo htmlspecialchars($notFoundText); ?></p>
<?php
  } else {
...
<?php     if ($showLanguage) { ?>
      <span class="search-entry-language"><small><?php echo htmlspecialchars($item->language, ENT_NOQUOTES); ?></small></span>
<?php     } ?>
<?php     if ($link) { ?>
...
<?php     if ($showDate) { ?>
    <div class="search-entry-date label label-default"><?php echo strftime($dateFormat, $item->pubDate); ?></div>
	<hr/>
<?php     } ?>
