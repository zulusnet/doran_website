...
<?php } ?>
  <div class="input-group">
	  <input type="text" name="words" class="search-words form-control" placeholder="<?php echo @$goText; ?>" value="<?php echo htmlspecialchars(@$_REQUEST['words']); ?>" <?php if ($placeholderText) echo 'placeholder="'.htmlspecialchars($placeholderText).'"'; ?>/>
	  <span class="input-group-btn">
		  <button type="submit" name="search" class="search-submit btn btn-default" type="button"><i class="fa fa-search"></i></button>
	  </span>
  </div><!--/.input-group -->
  <?php if ($is_ajax) { ?>
